...
!(function () {
  ...
  const Qo = (e, t, o) => (e.stype === Zo.Error ? t(e.serror) : o(e.svalue)),
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                (s = o),
                (a = M.some),
                s.stype === Zo.Value ? { stype: Zo.Value, svalue: a(s.svalue) } : s
              );
              var s, a;
            },
          );
      ...
      return {
        extract: (e, n) => {
          ...
          return 0 === s.length
            ? t.extract(e, n)
            : ((e, t) =>
                fn(e, () => 'There are unsupported fields: [' + t.join(', ') + '] specified'))(
                e,
                s,
              );
        },
    ...
    Nn = bn((e) =>
      Rn(e) ? on(e) : nn('Expected value to be acceptable for sending via postMessage'),
    ),
    Vn = (e, t) => ({
      extract: (o, n) =>
        be(n, e).fold(
    ...
    qn = (e) =>
      Hn((t) =>
        R(e, t)
          ? Jo.value(t)
          : Jo.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`),
      ),
      ...
      Fs(e, (e, o) => {
        const n = o.event,
          r = e
            ...
            .getByDom(n.target)
            .getOrThunk(() =>
              _r(n.target, (t) => e.getSystem().getByDom(t).toOptional(), _).getOr(e),
            );
        t(e, r, o);
      }),
    Hs = (e) =>
  ...
  const Qs = (e) => {
    ...
    ma = Qs('alloy-premade'),
    ga = (e) => (
      Object.defineProperty(e.element.dom, ma, { value: e.uid, writable: !0 }), Sr(ma, e)
    ),
    pa = (e) => be(e, ma),
    ha = (e) =>
      ((e, t) => {
        const o = t.toString(),
          ...
          s = o.substring(r + 1, n - 1).split(/,\s*/);
        return (
          (e.toFunctionAnnotation = () => ({ name: 'OVERRIDE', parameters: da(s.slice(1)) })), e
        );
    ...
    Ca = (e, t) =>
      ((e, t) => {
        ...
        return o.errors.length > 0
          ...
          : ((e, t) => (0 === e.length ? Jo.value(t) : Jo.value(cn(t, dn.apply(void 0, e)))))(
              o.values,
              t,
            );
        var n;
                      ...
                      console.log(e, {
                        ...
                        sequence: z(o, (e) =>
                          R(['cut', 'stopped', 'response'], e.outcome)
                            ? '{' + e.purpose + '} ' + e.outcome + ' at (' + Xs(e.target) + ')'
                            : e.outcome,
                        ),
                      });
                  },
  ...
  const fi = y(Cn(hi())),
    ...
    Xi = (e, t, o) =>
      Ei(Ui(e), $i(e), o.southeast(), Ai(), 'southeast', Li(e, { left: 1, top: 3 }), Pi),
    Ki = (e, t, o) =>
      Ei(ji(e, t), $i(e), o.southwest(), Di(), 'southwest', Li(e, { right: 0, top: 3 }), Pi),
    Yi = (e, t, o) =>
      Ei(Ui(e), Gi(e, t), o.northeast(), Bi(), 'northeast', Li(e, { left: 1, bottom: 2 }), Pi),
    Ji = (e, t, o) =>
      Ei(ji(e, t), Gi(e, t), o.northwest(), Fi(), 'northwest', Li(e, { right: 0, bottom: 2 }), Pi),
    Zi = (e, t, o) => Ei(Wi(e, t), Gi(e, t), o.north(), Ri(), 'north', Li(e, { bottom: 2 }), Pi),
    Qi = (e, t, o) => Ei(Wi(e, t), $i(e), o.south(), Ii(), 'south', Li(e, { top: 3 }), Pi),
    el = (e, t, o) =>
      Ei(((e) => e.x + e.width)(e), qi(e, t), o.east(), Ni(), 'east', Li(e, { left: 0 }), Pi),
    tl = (e, t, o) =>
      Ei(
        ((e, t) => e.x - t.width)(e, t),
        qi(e, t),
        ...
        return ((e, t) => {
          ...
          return o.collapsed
            ? t
                ...
                .map((e) =>
                  Fc.rtl(Ie(e.endContainer), e.endOffset, Ie(e.startContainer), e.startOffset),
                )
  ...
  const Gc = 'link-layout',
    ...
    Kc = (e) => e.y,
    Yc = (e, t, o) =>
      Ei($c(e), Kc(e), o.southeast(), Ai(), 'southeast', Li(e, { left: 0, top: 2 }), Gc),
    Jc = (e, t, o) =>
      Ei(qc(e, t), Kc(e), o.southwest(), Di(), 'southwest', Li(e, { right: 1, top: 2 }), Gc),
    Zc = (e, t, o) =>
      Ei($c(e), Xc(e, t), o.northeast(), Bi(), 'northeast', Li(e, { left: 0, bottom: 3 }), Gc),
    Qc = (e, t, o) =>
      Ei(qc(e, t), Xc(e, t), o.northwest(), Fi(), 'northwest', Li(e, { right: 1, bottom: 3 }), Gc),
    ed = () => [Yc, Jc, Zc, Qc],
    td = () => [Jc, Yc, Qc, Zc];
  var od = [
      Xn('item'),
      ...
      Oi('placement', (e, t, o) => {
        ...
        return M.some(
          rc({ anchorBox: n, bubble: nc(), overrides: t.overrides, layouts: r, placer: M.none() }),
        );
      }),
    ],
  ...
  const ud = hl({
    ...
    Dd = (e, t, o) => {
      ((e) => N(['top', 'left', 'right', 'bottom'], (t) => Dt(e, t).isSome()))(e.element) ||
  ...
  var Zd = [
    ...
    tu = [
      mr('store', { mode: 'memory' }, jn('mode', { memory: eu, manual: Qd, dataset: Zd })),
      wi('onSetValue'),
      ur('resetOnDom', !1),
    ];
  const ou = hl({
  ...
  const Nu = (e, t, o, n) =>
      cn(t.defaults(e, o, n), o, { uid: e.partUids[t.name] }, t.overrides(e, o, n)),
    Vu = (e, t) => {
      const o = {};
      return (
        L(t, (t) => {
            ...
            e.fold(
              ...
              (e) => {
                n[e.pname] = gu(!0, (t, o, n) => {
                  const r = t[e.name];
                  return z(r, (o) =>
                    e.factory.sketch(cn(e.defaults(t, o, n), o, e.overrides(t, o))),
                  );
                });
              },
            );
  ...
  const km = hl({ fields: Sm, name: 'disabling', active: wm, apis: xm }),
    ...
    Om = (e, t, o, n) => {
      Cm(e, t, 0, [n]),
        _m(e, t, o, n) || (Da(n.element, t.highlightClass), t.onHighlight(e, n), Cs(n, Ss()));
    },
    _m = (e, t, o, n) => Fa(n.element, t.highlightClass),
    Tm = (e, t, o) =>
      ri(e.element, '.' + t.itemClass).bind((t) => e.getSystem().getByDom(t).toOptional()),
    Em = (e, t, o) => {
  ...
  var Dm = Object.freeze({
      ...
      getHighlighted: (e, t, o) =>
        ri(e.element, '.' + t.highlightClass).bind((t) => e.getSystem().getByDom(t).toOptional()),
      getFirst: Tm,
      getLast: Em,
  ...
  const ng = (e, t, o, n, r) => {
      const s = (e, t, o, n, r) => {
          return ((s = o(e, t, n, r)),
          (a = t.event),
          G(s, (e) => e.matches(a)).map((e) => e.classification)).bind((o) => o(e, t, n, r));
          var s, a;
        },
        a = {
          schema: () =>
  ...
  var sg = rg($n('cyclic', _)),
    ag = rg($n('cyclic', T));
  const ig = (e, t, o) =>
      am(o) && qm(Hm)(t.event) ? M.none() : ((e, t, o) => (Ts(e, o, ns()), M.some(!0)))(e, 0, o),
    lg = (e, t) => M.some(!0),
    cg = [
      ur('execute', ig),
      ur('useSpace', !1),
  ...
  const zg = (e, t, o, n) => {
      const r = (e, t, o) => {
        ...
        return s === e
          ? M.none()
          : ((a = o[s]),
            'button' === ze(a) && 'disabled' === xt(a, 'disabled') ? r(e, s, o) : M.from(o[s]));
        var a;
      };
  ...
  const Xg = (e, t, o) =>
    ...
    ap = y([
      ...
      Zm(qm(Lm), yg(rp)),
      Zm(qm(Um), xg(sp)),
      Zm(qm(Hm.concat(Nm)), (e, t, o) => Cl(e.element).bind((n) => o.execute(e, t, n))),
    ]),
    ip = y([Zm(qm(Hm), lg)]);
  ...
  const Np = hl({ fields: [fr('reuseDom', !0)], name: 'replacing', apis: Rp }),
    Vp = (e, t) => {
      ...
      return {
        key: e,
        value: { config: {}, me: o, configAsRaw: y({}), initialConfig: {}, state: fa },
      };
    },
    Hp = (e, t) => {
  ...
  const Jp = () => {
    ...
    ch = [
      Xn('dom'),
      Xn('components'),
      Oi('builder', (e) => ({ dom: e.dom, components: e.components, events: As([zs(rs())]) })),
    ],
    dh = y('item-widget'),
    uh = y([
      Au({
        ...
        overrides: (e) => ({
          behaviours: gl([
            ou.config({ store: { mode: 'manual', getValue: (t) => e.data, setValue: b } }),
          ]),
        }),
      }),
    ]),
      ...
      factory: (e, t) => {
        ...
        const g = (t, o, s = m.HighlightSubmenu) => {
          ...
          p = (t, o) => {
            ...
            return n
              .collapse(s)
              .bind((r) => (d(t, r), u(t, n, r).map((n) => (e.onCollapseMenu(t, o, n), n))));
          },
          h = (t) => (o, n) =>
          ...
          y = {
            ...
            repositionMenus: (t) => {
              ...
              o.fold(
                () => {
                  ((e) =>
                    M.from(e.components()[0]).filter((e) => 'menu' === xt(e.element, 'role')))(
                    t,
                  ).each((o) => {
      ...
      factory: (e, t) => {
        const o = (e, t, o, r) => {
          ...
          n = (t, o, n, r) => {
            ...
            Nd.openWhileCloaked(t, o, () => ud.positionWithinBounds(s, t, n, r())),
              ou.setValue(t, M.some({ mode: 'position', config: n, getBounds: r }));
          },
          r = (t, o, n, r) => {
            const s = ((e, t, o, n, r) => {
  ...
  const Zf = 'tox-menu-nav__js',
    ...
    Sb = (e) =>
      ri(e.element, '.tox-menu__searcher').bind((t) => e.getSystem().getByDom(t).toOptional()),
    kb = Sb,
    Cb = (e) => ({
    ...
    Ib = (e, t, o, n, r) => {
      const s =
        ((a = o),
        {
          ...
          components: [
            bh.parts.items({ preprocess: (e) => Mb(e, (e, t) => 'separator' === a[t].type) }),
          ],
        });
      var a;
    ...
    Rb = (e, t, o, n, r) => {
      ...
      if ('listpreview' === r.menuType && 'auto' !== n) {
        const t = ((e) => ({
          ...
          components: [
            bh.parts.items({
              preprocess: Eb({ tag: 'div', classes: ['tox-collection__group'] }, e),
            }),
          ],
        }))(n);
        return { value: e, dom: t.dom, components: t.components, items: o };
    ...
    Cv = Cn(
      [
        ...
        Zb,
        or('commands', kv),
        rr('launch', jn('type', { contextformbutton: wv, contextformtogglebutton: Sv })),
      ].concat(vv),
    ),
  ...
  const ey = (e, t) => {
      ...
      return {
        ...
        itemBehaviours: gl(
          [
            ...
            km.config({ disabled: s, disableClass: 'tox-collection__item--state-disabled' })),
            oy(),
            Np.config({}),
      ...
      'color' === e.presets
        ...
        : ((e, t, o, n) => {
            const r = { tag: 'div', classes: [ob] },
              s = o
                ? e.iconContent.map((e) => Lh(e, r, t.icons, n)).orThunk(() => M.some({ dom: r }))
                : M.none(),
              a = e.checkMark,
    ...
    Py = (e) => {
      ...
      return (
        (t = Ny(255 * (t + d))), (o = Ny(255 * (o + d))), (n = Ny(255 * (n + d))), zy(t, o, n, 1)
      );
    },
    Uy = (e) => {
      const t = ((e) => {
  ...
  const Yy = {},
    ...
    bx = (e, t, o) =>
      e.concat(
        ((e) =>
          z(Jy(e).state(), (e) => ({ type: 'choiceitem', text: e, icon: 'checkmark', value: e })))(
          t,
        ).concat(hx(o)),
      ),
    vx = (e, t, o) => (n) => {
    ...
    Sx = (e) => (t, o) => {
      ...
      e.windowManager.open({
        ...
        onSubmit: (o) => {
          ...
          n
            ? (t(M.from(r)), o.close())
            : e.windowManager.alert(e.translate(['Invalid hex color code: {0}', r]));
        },
        onClose: b,
        onCancel: () => {
          t(M.none());
              ...
              behaviours: gl([
                Vp('insert-table-picker', [
                  ...
                  Vs(_x, (e, t, n) => {
                    ...
                    ((e, t, o, n, r) => {
                      for (let n = 0; n < 10; n++)
                        for (let r = 0; r < 10; r++) Yp.set(e[n][r], n <= t && r <= o);
                    })(o, s, a),
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: su(e.dropdownBehaviours, [
            ...
            Nx.config({
              others: {
                sandbox: (t) => Jx(e, t, { onOpen: () => Yp.on(t), onClose: () => Yp.off(t) }),
              },
            }),
            Tp.config({
              mode: 'special',
  ...
  const iw = (e, t, o, n, r) => {
      const s = o.shared.providers,
        a = (e) =>
          r ? { ...e, shortcut: M.none(), icon: e.text.isSome() ? M.none() : e.icon } : e;
      switch (e.type) {
        case 'menuitem':
    ...
    uw = (e, t) => {
                ...
                ((n = Ie(e.getBody())), ri(n, Xf)).each((n) => {
                  ...
                  Th.showMenuAt(
                    ...
                    ((e, t, o, n) => {
                      ...
                      Rb('autocompleter-value', !0, o, s, { menuType: 'normal' }),
                      s,
                      aw.ContentFocus,
                      'normal',
                    ),
      ...
      ((e, t) => {
        ...
        { cancelIfNecessary: c, isMenuOpen: s, isActive: a, isProcessingAction: o.get, getMenu: l },
        e,
      );
    },
    ...
    kw = (e) => {
      const t = (t) => et(e.element).fold(T, (e) => Xe(t, e)),
        ...
        r = hw(e.element, {
          triggerEvent: (e, t) =>
            mi(e, t.target, (o) => ((e, t, o, n) => xw(e, t, o, o.target, n))(n, e, t, o)),
        }),
        s = {
          debugInfo: y('real'),
          triggerEvent: (e, t, o) => {
        ...
        p = (e) =>
          o
            ...
            .fold(
              () =>
                Jo.error(new Error('Could not find component with uid: "' + e + '" in system.')),
              Jo.value,
            ),
        h = (e) => {
  ...
  const cC = Qs('alloy-fake-before-tabstop'),
    ...
    vC = (e, t, o) =>
      Lh(e, { tag: 'span', classes: ['tox-icon', 'tox-tbtn__icon-wrap'], behaviours: o }, t),
    yC = (e, t) => vC(e, t, []),
          ...
          ow.sketch({
            ...
            sandboxBehaviours: gl([
              ...
              Vp('dropdown-sandbox-events', [
                ...
                Fs(wb, (e, t) => {
                  ((e, t) => {
                    ((e) => Nd.getState(e).bind(Fm.getHighlighted).bind(Fm.getHighlighted))(e).each(
                      (o) => {
                        ((e, t, o, n) => {
                          const r = { ...n, target: t };
                          e.getSystem().triggerEvent(o, t, r);
  ...
  const qC = hl({ fields: $C, name: 'streaming', active: UC, state: GC }),
    ...
    OO = {
      ...
      button: CO((e, t) =>
        ((e, t) => {
          ...
          return (
            (n = M.none()),
            (r = _w.parts.field({ factory: Mh, ...lO(e, M.some(o), t, [sC(''), Jk()]) })),
            Dw(n, r, [], [])
          );
          var n, r;
        })(e, t.shared.providers),
        ...
        ((e, t, o, n) => {
          ...
          return _w.sketch({
            ...
            components: s
              .toArray()
              .concat([
                { dom: { tag: 'div', classes: ['tox-color-input'] }, components: [r, i.asSpec()] },
              ]),
            fieldBehaviours: gl([
              ...
              n &&
                (ou.setValue(
                  ...
                  ((e, t) => {
                    ...
                    return U(re(e), (e) =>
                      N(o, (t) => _e(e.name.toLowerCase(), `.${t.toLowerCase()}`)),
                    );
                  })(n, t),
                ),
                Os(o, Rw, { name: e.name }));
                  ...
                  CC(
                    {
                      ...
                      fetch: (o, n) => {
                        ...
                        n(
                          EC(r, Jf.CLOSE_ON_EXECUTE, t, { isHorizontalMenu: !1, search: M.none() }),
                        );
                      },
                      onSetup: y(b),
                      getApi: y({}),
      ...
      sizeinput: CO((e, t) =>
        ((e, t) => {
          ...
          const n = Qs('ratio-event'),
            r = (e) =>
              Lh(e, { tag: 'span', classes: ['tox-icon', 'tox-lock-icon__' + e] }, t.icons),
            s = VC.parts.lock({
              dom: {
                tag: 'button',
                      ...
                      zC(e, t.unit)
                        ...
                        .map((e) => {
                          return (
                            (o = e),
                            (n = t.unit),
                            (e) => zC(e, n).map((e) => ({ value: e * o, unit: n }))
                          );
                          var o, n;
                        })
                        .getOr(LC),
                ...
                const r = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        ...
                        return 'file' === e
                          ? ((s = [n, xO(r, fO(t)), xO(r, q([vO(t), bO(t), yO(t)]))]),
                            j(
                              s,
                              (e, t) =>
                                0 === e.length || 0 === t.length ? e.concat(t) : e.concat(mO, t),
                              [],
                            ))
                          : n;
                        var s;
              ...
              Ps((r) => {
                o.getOpt(r).each((o) => {
                  (((e) => ve(e, 'init'))(e)
                    ...
                    : iC.load(e.scriptId, e.scriptUrl).then((t) => t(o.element.dom, e.settings))
                  ).then((e) => {
                    n.on((t) => {
                      e.setValue(t);
                    }),
              ...
              rC(
                ...
                (e, t) => {
                  ...
                  n.getOpt(e).each((o) => {
                    ...
                    var r;
                    t.url !== xt(n, 'src') &&
                      (vt(n, 'src', t.url), Ba(e.element, 'tox-imagepreview__loaded')),
                      a(),
                      ((r = n),
                      new Promise((e, t) => {
                        const o = () => {
    ...
    HO = (e, t, o) =>
      Ei(DO(e), RO(e, t), o.insetSoutheast(), Bi(), 'southeast', Li(e, { left: 1, bottom: 3 }), AO),
    zO = (e, t, o) =>
      Ei(FO(e, t), IO(e), o.insetNorthwest(), Di(), 'northwest', Li(e, { right: 0, top: 2 }), AO),
    LO = (e, t, o) =>
      Ei(DO(e), IO(e), o.insetNortheast(), Ai(), 'northeast', Li(e, { left: 1, top: 2 }), AO),
    PO = (e, t, o) => Ei(BO(e, t), IO(e), o.insetNorth(), Ii(), 'north', Li(e, { top: 2 }), AO),
    UO = (e, t, o) =>
      Ei(BO(e, t), RO(e, t), o.insetSouth(), Ri(), 'south', Li(e, { bottom: 3 }), AO),
    ...
    ZO = (e, t) => () => ({
      ...
      getSelection: () => {
        ...
        return M.some(
          Mc.range(Ie(t.startContainer), t.startOffset, Ie(t.endContainer), t.endOffset),
        );
      },
    }),
    ...
    V_ = (e) => ({
      ...
      getLinkInformation: () =>
        ((e) =>
          Sf(e)
            ? M.some({ targets: __(e.getBody()), anchorTop: N_(kf(e)), anchorBottom: N_(Cf(e)) })
            : M.none())(e),
  ...
  const Z_ = (e) =>
    ...
    iT = (e, t, o) => {
      o.setDocked(!1),
        L(['left', 'right', 'top', 'bottom', 'position'], (t) => It(e.element, t)),
        t.onUndocked(e);
    },
    lT = (e, t, o, n) => {
    ...
    cT = (e, t, o, n, r = !1) => {
      t.contextual.each((t) => {
        t.lazyContext(e).each((s) => {
          ...
          a !== o.isVisible() &&
            (o.setVisible(a),
            r && !a ? (Ia(e.element, [t.fadeOutClass]), t.onHide(e)) : (a ? tT : oT)(e, t));
        });
      });
    },
    dT = (e, t, o) => {
      ...
      exhibit: (e, t, o) => {
        ...
        return ya(
          n
            ...
            : { classes: [t.closedClass], styles: Sr(t.dimension.property, '0px') },
        );
      },
      events: (e, t) =>
        As([
      ...
      cm
        ...
        .bind((e) =>
          qT.isGrowing(e) || qT.hasGrown(e)
            ? cm.getCurrent(e).bind((e) => G(QT.getSlotNames(e), (t) => QT.isShowing(e, t)))
            : M.none(),
        ),
    sE = Qs('FixSizeEvent'),
    aE = Qs('AutoSizeEvent');
  ...
  const cE = hl({
            ...
            if (
              ...
              cE.block(
                ...
                ((e) => (t, o) => ({
                  ...
                  components: [
                    { dom: dE('<div class="tox-spinner"><div></div><div></div><div></div></div>') },
                  ],
                }))(n),
              ),
                It(r, 'display'),
    ...
    bE = (e, t, o) => {
      ...
      0 === l.extra.length ? (Np.remove(r, s), o([])) : (fE(r, l.within), o(l.extra)),
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: su(e.splitToolbarBehaviours, [
            Nx.config({
              others: {
                overflowGroup: () => AE.sketch({ ...n['overflow-group'](), items: [r.asSpec()] }),
              },
            }),
          ]),
          apis: {
  ...
  const mM = {
    ...
    pM = (e, t) => {
      ...
      return U(
        i,
        (e) => e.getItems().length > 0 && N(e.getItems(), (e) => s(e) || 'separator' !== e.type),
      );
    },
    hM = (e) => {
      const t = () => {
  ...
  const AM = (e, t, o) => {
      const n =
        ((r = ((e, t) => (t === MM.SemiColon ? e.replace(/;$/, '').split(';') : e.split(' ')))(
          e.options.get(t),
          o,
        )),
        z(r, (e) => {
    ...
    BM = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(DM, (e) => e.format === t.format).each((t) => e.execCommand(t.command)),
        updateText: (t) => {
          const o = G(DM, (t) => e.formatter.match(t.format)).fold(y('left'), (e) =>
            e.title.toLowerCase(),
          );
    ...
    RM = ['-apple-system', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'sans-serif'],
    NM = (e) => {
      const t = e.split(/\s*,\s*/);
    ...
    WM = (e, t) => {
      ...
      return {
        ...
        updateText: (t) => {
          const n = (e) =>
              a_(e) ? X(e.items, n) : i_(e) ? [{ title: e.title, format: e.format }] : [],
            r = X(d_(e), n),
          ...
          ((e, t) => {
            const o = Qs('channel-update-split-dropdown-display'),
              n = (e) => ({
                ...
                isActive: () =>
                  ri(e.element, 'span').exists((t) => e.getSystem().getByDom(t).exists(Yp.isOn)),
              }),
              r = xr(b),
            ...
            return ZM.sketch({
              ...
              splitDropdownBehaviours: gl([
                ...
                oy(),
                Vp('split-dropdown-events', [Fs(oA, Up.focus), iy(s, r), ly(s, r)]),
                eS.config({}),
              ]),
        ...
        (e, t, o) => {
          ...
          if (df(o) === Wh.floating)
            return ((e, t, o, n) => {
              ...
              e,
              t,
              (e) => mA(o, { buttons: n, toolbar: e, allowToolbarGroups: !1 }, t, M.none()),
              r,
            );
        ...
        l = ((e, t, o, n, r) => {
          const { mainUi: s, uiMotherships: a } = o,
            ...
            b = (e) =>
              p
                ? e.fold(y(0), (e) =>
                    e.components().length > 1 ? Ht(e.components()[1].element) : 0,
                  )
                : 0,
            v = () => {
              L(a, (e) => {
                      ...
                      switch (mf(e)) {
                        case wA.auto:
                          ...
                          if (a.y > r) return 'top';
                          {
                            ...
                            return a.bottom < o - r || Xo().bottom < a.bottom - r
                              ? 'bottom'
                              : 'top';
                          }
                        case wA.bottom:
            ...
            const r = xr(kA(t, o.isPositionedAtTop())),
              s = (n) => {
                ...
                r.set({ pos: s, bounds: a }),
                  c && qy(e, n),
                  o.isVisible() &&
                    (i !== s ? o.update(!0) : c && (o.updateMode(), o.repositionPopups()));
              };
  ...
  const OA = 'contexttoolbar-hide',
              ...
              const r = 'node' === t ? s.anchors.node(n) : s.anchors.cursor(),
                c = ((e, t, o, n) =>
                  'line' === t
                    ...
                    : { bubble: oc(0, 12, DA, 1 / 12), layouts: RA(e, o, n, t), overrides: BA })(
                  e,
                  t,
                  a(),
                  {
                        ...
                        ((e, t, o) =>
                          e(t)
                            ...
                            : Or(
                                ...
                                (e) => {
                                  if (Pe(e)) {
                                    const { contextToolbars: t, contextForms: n } = NA(
                                        e,
                                        o.inNodeScope,
                                      ),
                                      r =
          ...
          ((e, t) =>
            M.from(GA.exec(e)).bind((e) => {
              ...
              return ((e, t) => N(t, (t) => N(jA[t], (t) => e === t)))(n, t)
                ...
                : M.none();
            }))(e, ['fixed', 'relative', 'empty']).map(({ value: e, unit: t }) => e + t))(e).getOr(
          e,
        ),
      display: x,
    ...
    uD = (e, t, o, n, r, s) => {
      ...
      EC(a, Jf.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !1, search: M.none() }).map((e) => {
        t.preventDefault(),
          Th.showMenuAt(r, { anchor: i }, { menu: { markers: ub('normal') }, data: e });
      });
    },
    mD = {
      ...
      const n = _o().deviceType.isTouch,
        ...
        i = (t) => {
          if (
            ...
            ((e, t) => t.ctrlKey && !nD(e))(e, t) || ((e) => 0 === sD(e).length)(e))
          )
            return;
          const a = ((e, t) => {
            const o = rD(e),
    ...
    cB = (e) =>
      Ah(
        Mh.sketch({
          ...
          buttonBehaviours: gl([
            aB.config({ mode: 'mouseOrTouch', blockerClass: 'blocker', snaps: e }),
            eS.config({}),
          ]),
          eventOrder: {
                  ...
                  const s = ((t) => {
                      ...
                      for (; n-- > 0; ) {
                        ...
                        if (
                          ...
                          const t = Xy(e, s);
                          if (
                            (t.isDefaultPrevented() || o.push({ name: t.name, element: s }),
  ...
  const gB = (e, t, o) => {
      ...
      const t = e.inline,
        ...
        h = ((e, t, o) => {
          const n = xr(!1),
            ...
            u = {
              ...d,
              shared: { ...d.shared, interpreter: (e) => MO(e, {}, u), getSink: e.popup },
            },
            m = {
              ...d,
              shared: { ...d.shared, interpreter: (e) => MO(e, {}, m), getSink: e.dialog },
            };
        ...
        b = () => {
          const o = (() => {
            ...
            n = {
              ...
              components: [
                uM.parts.socket({ dom: { tag: 'div', classes: ['tox-edit-area'] } }),
    ...
    XB = Hn((e) =>
      Ln('customeditor.old', kn(qB), e).orThunk(() => Ln('customeditor.new', kn($B), e)),
    ),
    KB = Bn,
    YB = Cn(IB),
    JB = On(vn),
    ...
    ZF = (e, t, o) => {
      ...
      return {
        ...
        behaviours: gl([
          ...
          oC(n, { postprocess: (e) => JF(e).fold((e) => (console.error(e), {}), x) }),
        ]),
      };
      var r;
    },
  ...
  var eR = FI([
    ...
    wR = (function e() {
      ...
      if (((o.version = '2.3.8'), (o.removed = []), !t || !t.document || 9 !== t.document.nodeType))
        ...
        Ve = function (e) {
          ...
          return e instanceof l && !Me(e)
            ...
            ? (Y &&
                ...
                (t = GI(t, I, ' ')),
                e.textContent !== t &&
                  (UI(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
        ...
        He = function (e, t, o) {
          ...
          if (X && !$[t] && XI(R, t));
            ...
            if (
              !(
                (ze(e) &&
                  ((j.tagNameCheck instanceof RegExp && XI(j.tagNameCheck, e)) ||
                    (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                  ((j.attributeNameCheck instanceof RegExp && XI(j.attributeNameCheck, t)) ||
                    (j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)))) ||
                ('is' === t &&
                  j.allowCustomizedBuiltInElements &&
                  ((j.tagNameCheck instanceof RegExp && XI(j.tagNameCheck, o)) ||
  ...
  const SR = (e) => wR().sanitize(e),
    ...
    ER = (e) =>
      wB.parts.footer({ dom: { tag: 'div', classes: ['tox-dialog__footer'] }, components: e }),
    MR = (e, t) => [
      Sw.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-start'] }, components: e }),
      Sw.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-end'] }, components: t }),
    ],
    AR = (e) => {
      const t = 'tox-dialog',
        o = t + '-wrap',
            ...
            const c = Pn(Ln('data', l, i)),
                  ...
                  p = Ka({
                    ...
                    behaviours: gl([
                      Tp.config({
                        ...
                        useTabstopAt: (e) =>
                          !hC(e) && ('button' !== ze(e) || 'disabled' !== xt(e, 'disabled')),
                      }),
                      qM.config({
                        channel: `${fI}-${r}`,
                        updateState: (e, t) => M.some(t),
              ...
              p = Ka(
                Th.sketch({
                  ...
                  isExtraPart: (e, t) =>
                    ((e) => mw(e, '.tox-alert-dialog') || mw(e, '.tox-confirm-dialog'))(t),
                }),
              );
            return (
              d.set(p),
